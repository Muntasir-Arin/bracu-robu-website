...
function Footerlinks() {
  ...
  <div className="flex mb-4  ">
        <a href="https://www.facebook.com/BRACU.Robotics.Club" className=" mr-6 text-accent-foreground">
          <svg
        ...
        <a href="https://x.com/bracuniversity" className="mr-6 text-accent-foreground">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="currentColor"
        ...
        <a href="https://www.instagram.com/bracu_robu/" className="mr-6 text-accent-foreground">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="currentColor"
        ...
        <a href="https://bd.linkedin.com/company/brac-university-robotics-club" className="mr-6 text-accent-foreground">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="currentColor"
      ...
      <div className="-mx-4 flex flex-wrap lg:justify-between">
        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div className="mb-12 max-w-[570px] lg:mb-0">
            <span className="text-accent-foreground mb-4 block text-base font-semibold">
              Contact Us
            </span>
            <h2
              className="text-accent-foreground mb-3 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
            >
              GET IN TOUCH WITH US
            </h2>
            <Footerlinks/>
            <p className="text-accent-foreground mb-9 text-base leading-relaxed">
            Connect with us and stay up-to-date on all the latest news, promotions, and exciting updates! Follow us on social media for exclusive content, behind-the-scenes glimpses, and opportunities to engage with our vibrant community. Join the conversation, share your thoughts, and be a part of our journey!  See you there!
            </p>
            <div className="mb-8 flex w-full max-w-[370px]">
            <div
                className=" text-accent-foreground mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div className="w-full">
                <h4 className="text-accent-foreground mb-1 text-xl font-bold">Our Location</h4>
                <p className="text-accent-foreground text-base">
                Brac University | Progati Sarani, Merul Badda, Dhaka 1212
                </p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                <h4 className="text-accent-foreground mb-1 text-xl font-bold">Phone Number</h4>
                <p className="text-accent-foreground text-base"> +8801973054376</p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div className="w-full">
                <h4 className="text-accent-foreground mb-1 text-xl font-bold">Email Address</h4>
                <p className="text-accent-foreground text-base">club.robu@g.bracu.ac.bd</p>
              </div>
            </div>
          </div>
        </div>
